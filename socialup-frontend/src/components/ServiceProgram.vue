      ...
      <div class="container">
        ...
        <div class="md-layout md-gutter">
          <div class="md-layout-item md-size-40 md-small-size-100">
            <div class="work-details-inner-area"><!-- work details inner area -->
              <div class="thumb md-layout md-alignment-center-center">
                <img class="md-layout-item" :src="`../src/assets/img/banner/program.jpg`" alt="work details image">
              </div>
            </div>
          </div>
          <div class="md-layout-item md-size-60 md-small-size-100">
            <div class="work-details-inner-area"><!-- work details inner area -->
              <p style="color: black;">
                고객님이 직접 본인의 컴퓨터에서 프로그램을 구동시켜 계정을 관리하는 방식입니다. <br>
                프로그램을 동작시킬때는 컴퓨터를 계속 켜놓으셔야 합니다.
              </p>
              <p>기능 - (클릭시 상세설명)</p>
              <div v-for="(desc, index) in description" :key="index" style="margin-top: 10px;">
                <a data-toggle="collapse" :data-target="`#collapse${index}`" aria-expanded="true" :aria-controls="`collapse${index}`" style="cursor: pointer;">
                  <p style="font-weight: bold;">{{desc.title}}</p>
                </a>
              ...
              <div class="md-layout-item1" style="margin-right:10px;">
                <md-field>
                  ...
                  <md-select v-model="buyData.period" name="period" id="period" @md-selected="changePeriod">
                    ...
                    <md-option :value="99">99개월</md-option>
                  </md-select>
                </md-field>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      buyOption: [
        { period: 1, price: 33000, salePrice: 22000, count: 1},
        { period: 3, price: 99000, salePrice: 33000, count: 1},
        { period: 6, price: 198000, salePrice: 44000, count: 1},
        { period: 12, price: 396000, salePrice: 55000, count: 1},
        { period: 99, price: 3267000, salePrice: 99000, count: 1},
      ],
      description: [
        {title: '1. 소통서비스', text: '인스타그램 실사용자들에게 "팔로우/좋아요/댓글" 을 통해 반응을 유도하는 방식으로 계정을 성장시킵니다. 따라서 특정분야에 관심있는 유저들을 자신의 팔로워로 만들 수 있습니다. (예. 패션스타그램, 옷스타그램, #데일리 #데일리패션 을 통해 옷에 관심있어하는 유저들을 타겟팅 할수있습니다.)'},
        {title: '2. 내팔로워 관리', text: '내 팔로워들에게 먼저 좋아요와 댓글을 달아줌으로써 팔로워와의 관계를 진전시켜 나의 고객으로 만들 수 있습니다.'},
        {title: '3. 예약포스팅 / 반복포스팅', text: '예약포스팅 및 반복포스팅을 통해 원하는시간에 원하는 간격으로 자신의 컨텐츠를 유저들에게 노출시킬 수 있습니다.'},
        {title: '4. 실시간 대시보드', text: '팔로우 좋아요 댓글 언팔로우 의 활동내역이 실시간으로 나타나며, 팔로우, 팔로잉 변화 그래프를 한눈에 볼수 있어 계정상태를 쉽게 파악할 수 있습니다.'},
        {title: '5. 친구관리', text: '친구목록 전체를 불러와 맞팔하지않은 유저(언팔), 나를 팔로우한 유저, 맞팔한 유저로 쉽게 분류해서 볼 수 있으며 언팔로우 할 수 있습니다.'},
        {title: '6. 내 계정분석', text: '자신의 최신 게시물에서 많이 사용하는 태그 순위를 볼수 있고, 게시글마다 좋아요, 댓글갯수로 참여도를 분석할 수 있습니다.'},
      ],
