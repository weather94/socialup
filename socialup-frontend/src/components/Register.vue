        ...
        <div class="row justify-content-center">
          <b-form>
            <b-form-group id="exampleInputGroup1" label-for="exampleInput1"
              ...
              <b-form-input id="exampleInput1" v-model="member.email" :state="check.email" @input="checkEmail" type="email" required placeholder="이메일"></b-form-input>
            </b-form-group>
            <b-form-group id="exampleInputGroup2" label-for="exampleInput2">
              <b-form-input id="exampleInput2" type="password" v-model="member.password" :state="check.pw" @input="checkPassword" required placeholder="비밀번호"> </b-form-input>
            </b-form-group>
            <b-form-group id="exampleInputGroup3" label-for="exampleInput3" description="비밀번호는 6글자 이상 입력해주세요." :state="check.pw" :invalid-feedback="mention.pw">
              <b-form-input id="exampleInput3" type="password" v-model="member.password2" :state="check.pw" @input="checkPassword" required placeholder="비밀번호 확인"> </b-form-input>
            </b-form-group>
            ...
            <b-button type="button" variant="primary" @click="register">회원가입</b-button>
            <b-button type="reset" variant="danger" :to="{path: '/'}">취소</b-button>
          </b-form>
        </div>
      </div>
  </div>
