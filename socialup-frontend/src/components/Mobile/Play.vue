<template>
  <div class="instgram-log-wrapper gray-bg">
    ...
    <div v-if="periodProxy && periodProxy.instagramProxys.length !== 0" class="container" style="padding-top:15px; padding-bottom: 30px;">
      <div class="md-layout">
...
export default {
  ...
  methods: {
    ...
    goDashboard(id) {
      this.$router.push(`/mobile/dashboard/${btoa(id)}`)
    },
    addInstagramProxy() {
