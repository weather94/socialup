  ...
  <div>
    <!-- <section class="breadcrumb-area breadcrumb-bg">
      <div style="position: absolute; width:100%; height: 100%; text-align: center;">
        <div class="wow fadeInDown" style="color: #d7d7d7; font-size: 3rem; font-weight: 500;">
          소셜업 서비스
        </div>
      </div>
    </section> -->
      ...
      <div class="md-layout md-gutter md-alignment-center-center">
        <div class="md-layout-item md-size-30 md-small-size-100">
          <md-card class="single-price-plan-01" style="border-radius: 10px;">
            ...
            <div class="hovermac" @click="route('/mobile/service/proxy')">
            ...
            <img src="../../assets/img/banner/proxy.jpg" alt="" style="border-radius: 10px;">
          </md-card>
        </div>
        <div class="md-layout-item md-size-30 md-small-size-100">
          <md-card class="single-price-plan-01" style="border-radius: 10px;">
            <div class="hovermac" @click="nopc">
              <div class="hovermac-item md-layout md-alignment-center-center" style="margin-top: 80%;">
                <md-button class="md-layout-item md-raised md-accent">
                  알아보기
                </md-button>
            ...
            <img src="../../assets/img/banner/program.jpg" alt="" style="border-radius: 10px;">
          </md-card>
        </div>
        <div class="md-layout-item md-size-30 md-small-size-100">
          <md-card class="single-price-plan-01" style="border-radius: 10px; background-color: white">
            ...
            <img src="../../assets/img/banner/up.jpg" alt="" style="border-radius: 10px;">
          </md-card>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    ...
    nopc() {
      alert('PC에서만 이용가능한 프로그램입니다. PC에서 확인해주세요.');
    },
    nolaunching() {
      alert('런칭 준비중인 기능입니다!');
    },
