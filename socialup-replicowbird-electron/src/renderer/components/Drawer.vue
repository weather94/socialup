    ...
    <md-app class="weather-tmargin-64">
      ...
      <md-app-drawer :md-active.sync="menuVisible" md-permanent="clipped" md-persistent="mini">
        ...
        <md-list>
          ...
          <md-list-item @click="route('emailaccountpage')" :style="selectedPage === '/emailaccountpage' ? {backgroundColor: '#d7d7d7'} : null">
            <md-icon>email</md-icon>
            <md-tooltip md-direction="top">이메일계정</md-tooltip>
            <span class="md-list-item-text">이메일계정</span>
          </md-list-item>
...
export default {
  ...
  mounted() {
    InstaAPI.login('cowbird2018', 'rhrnak00!', 'cowbird2018');
